...
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_02/img/function_example.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_02/img/help_page.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_02/img/paquetes_hexa.png")
```
