...
knitr::include_graphics("https://user-images.githubusercontent.com/23284899/164083485-8a0cb088-e04d-4234-88f4-439289234530.png")
```
...
knitr::include_graphics("https://user-images.githubusercontent.com/23284899/164085004-8f34ca37-3780-4790-91cc-c934f594b34b.png")
```

### Reconocimiento Rstudio

```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/01_IDE_Rdtudio_v1.png")
```


```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/01_IDE_Rdtudio_v2.png")
```

### Mover paneles 

```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/03_panel_v1.png")
```

```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/03_panel_v2.png")
```

### Personalización de Rstudio

```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/04_config_global_v1.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/04_config_global_v2.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_1.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_3.png")
```
3. Aparecerán más opciones y seleccionamos nuevamente “New Project”

```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_4.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_5.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_6.png")
```
...
```{r echo=FALSE, out.width="85%", fig.align='center'}
knitr::include_graphics("https://healthinnovation.github.io/curso-introduccion-r-tidyverse/sesion_01/img/creacion_proyectos_6.gif")
```
